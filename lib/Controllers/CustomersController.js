...
/** 
 * @typedef {import('../Responsecallback')} ResponseCallback
 * @typedef {import('../Models/UpdateCardRequest')} UpdateCardRequest
 * @typedef {import('../Models/GetCardResponse')} GetCardResponse 
 * @typedef {import('../Models/UpdateAddressRequest')} UpdateAddressRequest
 * @typedef {import('../Models/GetAddressResponse')} GetAddressResponse
 * @typedef {import('../Models/GetCustomerResponse')} GetCustomerResponse
 * @typedef {import('../Models/ListAccessTokensResponse')} ListAccessTokensResponse
 * @typedef {import('../Models/ListAddressesResponse')} ListAddressesResponse
 * @typedef {import('../Models/ListCardsResponse')} ListCardsResponse
 * @typedef {import('../Models/GetAccessTokenResponse')} GetAccessTokenResponse
 * @typedef {import('../Models/CreateAddressRequest')} CreateAddressRequest
 * @typedef {import('../Models/CreateCardRequest')} CreateCardRequest
 * @typedef {import('../Models/ListCustomersResponse')} ListCustomersResponse
 */
...
class CustomersController {
     ...
     * @param {ResponseCallback} [callback]   The callback function that returns response from the API call
     *
     * @returns {Promise<GetCardResponse>}
     */
    static updateCard(customerId, cardId, request, idempotencyKey, callback) {
        ...
        const _headers = {
            ...
            'user-agent': 'MundiSDK - Node 0.16.15',
        };
     ...
     * @param {ResponseCallback} [callback] The callback function that returns response from the API call
     *
     * @returns {Promise<GetAddressResponse>}
     */
     ...
     * @param {ResponseCallback} [callback]  The callback function that returns response from the API call
     *
     * @returns {Promise<ListAccessTokensResponse>}
     */
     ...
     * @param {ResponseCallback} [callback] The callback function that returns response from the API call
     *
     * @returns {Promise<ListCardsResponse>}
     */
     ...
     * @param {ResponseCallback} [callback]    The callback function that returns response from the API call
     *
     * @returns {Promise<ListCustomersResponse>}
     */
